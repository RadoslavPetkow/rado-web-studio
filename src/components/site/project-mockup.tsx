...
export function ProjectMockup({ project, labels = en.projectMockup }: ProjectMockupProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-zinc-950 p-3 shadow-2xl shadow-zinc-950/20">
      ...
      <div className="relative flex items-center gap-1.5 pb-3">
        ...
        <div className="ml-3 h-5 flex-1 rounded-full border border-white/10 bg-white/10" />
      </div>

      <div className="relative rounded-xl border border-white/10 bg-white p-3">
        ...
        <div className="relative mt-4 overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50 p-3">
          <div className={`absolute inset-x-0 top-0 h-20 ${style.soft}`} />
          <div className="relative grid gap-4 lg:grid-cols-[1fr_0.42fr]">
            <div className="rounded-xl border border-white/80 bg-white/85 p-4 shadow-lg shadow-zinc-950/5 backdrop-blur">
              ...
              <div className="mt-5 grid grid-cols-2 gap-2">
                <span className="rounded-lg bg-zinc-950 px-3 py-2 text-center text-[10px] font-semibold text-white">
                  {labels[style.primaryKey]}
                </span>
                <span className="rounded-lg border border-zinc-200 bg-white px-3 py-2 text-center text-[10px] font-semibold text-zinc-700">
                  {labels.viewServices}
                </span>
              </div>
            </div>
          ...
          <div className="absolute bottom-3 right-4 hidden w-20 rounded-2xl border-4 border-zinc-950 bg-white p-2 shadow-xl shadow-zinc-950/20 md:block">
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          {project.features.slice(0, 4).map((feature) => (
            <div
              key={feature}
              className="flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-700 shadow-sm"
            >
