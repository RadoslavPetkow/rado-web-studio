...
export const it = {
  ...
  footer: {
    ...
    built: "Costruito per chiarezza, velocità e crescita nel tempo.",
  },
  home: {
    ...en.home,
    hero: {
    ...
    processHeading: {
      eyebrow: "Come lavoro",
      title: "Dalla prima richiesta al lancio del progetto.",
      description:
        "Il processo rende chiaro il prossimo passo prima di qualsiasi lavoro a pagamento. Prima confermiamo obiettivi e ambito, poi i progetti approvati ricevono uno spazio nel portale clienti.",
    },
    processCtas: {
      request: "Inizia con una richiesta",
      ...
      factors: [
        {
          ...
          description: "Una landing page è più semplice di un sito con più pagine di servizi.",
        },
        {
          title: "Complessità del design",
          description: "Sezioni personalizzate e dettagli visuali aumentano l'ambito.",
        },
        {
          title: "Form e integrazioni",
          description: "Form, mappe, analytics, prenotazioni e strumenti esterni richiedono setup.",
        },
        {
          title: "Portale o dashboard",
          description: "Login, admin, tracking e sistemi clienti sono lavoro software su misura.",
        },
        {
          title: "Automazioni AI",
          description: "Chatbot e workflow interni vengono quotati in base al processo.",
        },
        {
          title: "Supporto dopo il lancio",
          description: "Manutenzione, miglioramenti e monitoraggio possono essere gestiti mensilmente.",
        },
        {
          title: "Urgenza della timeline",
          description: "Scadenze molto rapide possono richiedere ambito più stretto o priorità.",
        },
      ],
    },
    maintenanceHeading: {
      eyebrow: "Cura mensile",
      title: "Piani di manutenzione dopo il lancio.",
      description:
        "Per attività che vogliono piccoli aggiornamenti, supporto, monitoraggio e miglioramenti continui.",
    ...
    faq: {
      eyebrow: "FAQ",
      title: "Domande comuni su prezzi e progetti.",
      description:
        "Risposte chiare su costi, tempi, supporto e cosa è incluso prima di definire l'ambito.",
    },
    contact: {
  ...
  services: [
    ...
    {
      title: "Manutenzione e miglioramenti",
      description:
        "Supporto continuo, piccoli aggiornamenti, controlli performance, SEO base e ottimizzazioni dopo il lancio.",
      icon: "compass",
    },
  ],
  process: [
    ...
    },
    {
      step: "03",
      title: "Ambito",
      description: "Chiariamo ambito, tempi, aspettative, comunicazione e cosa è incluso.",
    },
    {
      step: "04",
      title: "Portale",
    ...
    },
    {
      step: "05",
      title: "Build",
      description: "Costruisco la versione concordata e tengo la comunicazione organizzata.",
    },
    {
      step: "06",
      title: "Lancio",
      description: "Rivediamo, rifiniamo, testiamo l'essenziale e pubblichiamo.",
    },
  ],
  demoProjects: [
    {
  ...
  maintenancePlans: [
    {
      name: "Basic Care",
      price: "€39/mese",
      description: "Supporto semplice per mantenere sano un piccolo sito.",
      features: ["Controllo salute sito", "Piccole modifiche testo", "Aiuto dominio/hosting", "Supporto base"],
    },
    {
      name: "Standard Care",
      price: "€59/mese",
      description: "Piano pratico per piccoli miglioramenti regolari.",
      features: ["Fino a 2 ore di modifiche al mese", "Aggiornamenti contenuti", "Piccole nuove sezioni", "Monitoraggio problemi", "Riepilogo mensile"],
      featured: true,
    },
    {
      name: "Premium Care",
      price: "€99/mese",
      description: "Supporto prioritario per miglioramenti più forti.",
      features: ["Fino a 4 ore di lavoro al mese", "Miglioramenti SEO", "Miglioramenti landing page", "Controlli performance", "Supporto prioritario"],
    },
  ],
  reasons: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Una landing semplice può essere completata in pochi giorni dopo che i contenuti sono pronti. Un sito aziendale richiede di solito 1-2 settimane, secondo pagine, revisioni e funzioni.",
    },
    {
      question: "Offri supporto dopo il lancio?",
      answer:
        "Sì. Offro piani di manutenzione da €39/mese per piccoli aggiornamenti, monitoraggio, supporto e miglioramenti.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. Il portale si usa dopo l'approvazione del progetto. Aiuta a seguire progressi, stati e comunicazione. Il primo passo è una semplice richiesta e revisione gratuita.",
    },
    {
      question: "Garantisci più clienti?",
      answer:
        "Nessuno può garantire vendite, ma un sito professionale può migliorare fiducia, presentazione, velocità, esperienza mobile e probabilità di contatto.",
    },
  ],
  form: {
    fields: {
    ...
    errors: {
      ...
      failed: "Qualcosa è andato storto. Puoi scrivermi direttamente a",
    },
    mailtoSuccess:
  ...
  contactPage: {
    ...
    flow: [
      ...
      "Rispondo con domande o una direzione suggerita.",
      "Chiariamo ambito, tempi e aspettative.",
      "Se il progetto va avanti, crei un account nel portale.",
      "Creo lo spazio di lavoro del progetto.",
      "Comunichiamo e seguiamo i progressi nel portale.",
      "Rivediamo, rifiniamo e lanciamo.",
    ],
    portalNote:
    ...
    portalDescription:
      "Il primo passo è una semplice richiesta. Dopo aver confermato che il progetto è adatto, il portale diventa lo spazio per dettagli, messaggi, progressi e revisione.",
    portalSteps: ["Richiesta", "Chiarimento", "Approvazione", "Spazio portale"],
  },
  startPage: {
    badge: "Checklist di avvio progetto",
    title: "Prepara i dettagli giusti prima di iniziare.",
    description:
    ...
    sections: [
      {
        ...
        description: "Le basi: cosa fai, chi aiuti e come i clienti possono contattarti.",
        items: ["Nome attività", "Breve descrizione", "Servizi/prodotti principali", "Clienti target", "Posizione se rilevante", "Dettagli contatto"],
      },
      {
        title: "Asset del brand",
        description: "Materiale visuale utile per rendere il sito coerente e credibile.",
        items: ["Logo", "Colori brand", "Font se disponibili", "Foto/immagini", "Link social"],
      },
      {
        title: "Contenuti del sito",
        description: "Testi e sezioni che aiutano i visitatori a capire l'offerta.",
        items: ["Testo homepage", "Servizi/prezzi", "Chi siamo", "FAQ", "Contatti", "Pagine legali se necessarie"],
      },
      {
        title: "Accessi e dettagli tecnici",
        description: "Account e link esistenti che rendono setup, SEO e pubblicazione più fluidi.",
        items: ["Dominio esistente", "Accesso hosting se disponibile", "Link vecchio sito", "Link Google Maps", "Analytics/Search Console se rilevante"],
      },
      {
        title: "Preparazione al lancio",
        description: "Controlli finali prima che il progetto sia visibile ai clienti.",
        items: ["Approvazione contenuti", "Revisione mobile", "Test form", "Controllo SEO base", "Controllo dominio/deployment"],
      },
    ],
    feedbackTitle: "Feedback e revisioni",
    feedbackDescription:
      "Un feedback chiaro accelera il progetto. Spiega cosa cambiare, perché conta e se riguarda contenuto, design o funzione.",
    feedbackBody:
      "I round di revisione vanno concordati prima di iniziare, così il processo resta chiaro.",
    readyTitle: "Pronto a iniziare?",
    readyDescription:
      "Non serve avere tutto perfetto prima di contattarmi. Se mancano dettagli, li identifichiamo nella prima conversazione.",
    flowTitle: "Come la richiesta diventa progetto nel portale",
    flow: ["Invii una richiesta", "Chiariamo ambito", "Crei l'account portale", "Segui i progressi nello spazio progetto"],
    portalNote: "Il portale si usa solo per progetti approvati, quindi prima confermiamo che il progetto sia adatto.",
  },
  privacyPage: {
    ...
    questionsDescription: "Invia un messaggio e lo rivedrò direttamente.",
    sections: [
      {
      ...
      {
        title: "Dati account portale clienti",
        body: [
          "Se crei un account portale, il sito può salvare email, nome, azienda, telefono, ruolo e data di creazione.",
          "Questo serve per login, accesso ai progetti e separazione tra clienti e admin.",
        ],
      },
      {
        title: "Dati progetto e messaggi",
        body: [
          "Per progetti attivi, il portale può salvare titoli, descrizioni, servizio, budget, stato, date e messaggi.",
          "I messaggi vengono salvati per mantenere la comunicazione in un posto solo.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Il sito può usare strumenti esterni per hosting, analytics, form, autenticazione e database.",
          "Dominio, hosting, strumenti a pagamento e servizi esterni possono avere policy proprie.",
        ],
      },
      { title: "Contatto", body: ["Per domande privacy: radigoig@gmail.com."] },
    ],
  },
  termsPage: {
    ...
    questionsDescription: "Invia un messaggio prima di iniziare un progetto.",
    sections: [
      {
      ...
      {
        title: "Ambito e comunicazione",
        body: [
          "Prima del lavoro a pagamento chiariamo obiettivo, pagine o funzioni, timeline, responsabilità e deliverable.",
          "La comunicazione può avvenire via email, form, messaggi nel portale o altro canale concordato.",
        ],
      },
      {
        title: "Pagamenti",
        body: [
          "I pagamenti non sono gestiti direttamente dalla piattaforma in questa fase.",
          "Per lavoro pagato, termini, fatture, depositi o bonifici possono essere gestiti separatamente.",
        ],
      },
      {
        title: "Responsabilità del cliente",
        body: [
          "Il cliente fornisce informazioni corrette, contenuti, immagini, accessi, feedback, approvazioni e account esterni necessari.",
          "Dominio, hosting, strumenti a pagamento e servizi esterni non sono inclusi nel prezzo base salvo accordo scritto.",
        ],
      },
      {
        title: "Revisioni e modifiche",
        body: [
          "Le revisioni ragionevoli si discutono nell'ambito. Pagine, funzioni o cambi importanti possono richiedere nuovo preventivo.",
          "L'obiettivo è mantenere aspettative chiare prima di iniziare e prima di cambiare ambito.",
        ],
      },
      {
      ...
      {
        title: "Accordi formali",
        body: [
          "Per lavoro pagato si può usare una proposta, fattura o documento di progetto separato.",
          "Se c'è differenza tra questa pagina e un accordo specifico, l'accordo specifico guida il lavoro.",
        ],
      },
      { title: "Contatto", body: ["Per domande sui termini: radigoig@gmail.com."] },
    ],
  },
