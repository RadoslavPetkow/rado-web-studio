export const en = {
  ...
  footer: {
    ...
    built: "Built for clarity, speed, and long-term growth.",
  },
  home: {
    hero: {
    ...
    processHeading: {
      ...
      description:
        "The workflow is designed to make the next step clear before any paid work begins. First we confirm fit and scope, then approved projects move into a client portal workspace for organized updates and communication.",
    },
    processCtas: {
      request: "Start with a request",
      ...
      factors: [
        {
          ...
          description:
            "A focused landing page is simpler than a full website with several service pages.",
        },
        {
          title: "Design complexity",
          description:
            "More custom sections, visual polish, and layout detail can increase the scope.",
        },
        {
          title: "Forms and integrations",
          description:
            "Contact forms, maps, analytics, booking tools, and third-party services affect setup time.",
        },
        {
          title: "Portal or dashboard features",
          description:
            "Login areas, admin views, project tracking, and client systems are custom software work.",
        },
        {
          title: "AI automations",
          description:
            "Chatbots, follow-up flows, and internal automations are quoted around the workflow.",
        },
        {
          title: "Support after launch",
          description:
            "Maintenance, improvements, monitoring, and updates can be handled monthly.",
        },
        {
          title: "Timeline urgency",
          description:
            "Very fast timelines may require tighter scope or priority scheduling.",
        },
      ],
    },
    maintenanceHeading: {
      ...
      description:
        "For businesses that want small updates, support, monitoring, and steady improvements without starting a new project every time.",
    ...
    faq: {
      ...
      description:
        "Clear answers about website costs, timelines, support, and what is included before we agree on scope.",
    },
    contact: {
  ...
  form: {
    ...
    errors: {
      ...
      failed: "Something went wrong. You can email me directly at",
    },
    mailtoSuccess:
  ...
  contactPage: {
    ...
    portalDescription:
      "The first step is a simple request. After we confirm the project is a good fit, the client portal becomes the project workspace for details, messages, progress, and review. The portal is a support and trust feature for approved projects, not something you need before sending a request.",
    portalSteps: ["Request", "Clarify", "Approve", "Portal workspace"],
  },
  startPage: {
    badge: "Project Start Checklist",
    title: "Prepare the right details before your project starts.",
    description:
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Logo", "Brand colors", "Fonts if available", "Photos/images", "Social media links"],
      },
      {
    ...
    feedbackTitle: "Feedback and revisions",
    feedbackDescription:
      "Clear feedback helps the project move faster. Useful feedback explains what should change, why it matters, and whether it affects content, design, functionality, or business goals.",
    feedbackBody:
      "Revision rounds should be agreed before work starts, so the project has a clear review process and enough room for improvements without turning into an undefined scope.",
    readyTitle: "Ready to start?",
    readyDescription:
      "You do not need to have everything perfect before reaching out. If some details are missing, we can identify what is needed during the first project conversation.",
    flowTitle: "How the request becomes a portal project",
    flow: [
      "Submit a request",
    ...
    portalNote:
      "The portal is used only for approved projects, so first we confirm that the project is a good fit.",
  },
  privacyPage: {
    ...
    questionsTitle: "Questions about privacy?",
    questionsDescription: "Send a message and I will review it directly.",
    sections: [
      {
      ...
      {
        title: "Contact",
        body: ["For privacy questions or data requests, contact radigoig@gmail.com."],
      },
    ],
  },
  termsPage: {
    ...
    questionsTitle: "Questions about the terms?",
    questionsDescription: "Send a message before starting a project.",
    sections: [
      {
      ...
      {
        title: "Contact",
        body: ["For questions about these terms, contact radigoig@gmail.com."],
      },
    ],
  },
} as const;
